<template>
    <div>
    <aside class="w-64 overflow-y-auto py-4 px-3 bg-gray-50 fixed sideNav dark:bg-gray-800" aria-label="Sidebar">
        <ul class="space-y-2">
            <div class="flex justify-center rounded-md shadow-sm" role="group">
                <button type="button" class="py-2 px-4 text-sm flex-1 font-medium items-center text-gray-900 bg-transparent rounded border border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
                    Add group
                </button>
