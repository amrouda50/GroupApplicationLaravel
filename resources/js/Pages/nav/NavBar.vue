...
<nav class="bg-white fixed w-full border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900  top-0">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="items-center flex flex-col px-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li v-if="IsLoggedIn">
                    <img v-on:click="showStatus()"  :src="require('~/images/avatar-svgrepo-com.svg')" alt="Avatar"
                         class="mr-3 cursor-pointer h-6 sm:h-9 rounded-full">
